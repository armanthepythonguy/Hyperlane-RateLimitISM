...
export interface TestMailboxInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "MAX_MESSAGE_BODY_BYTES" | "VERSION" | "count" | "defaultIsm" | "delivered" | "dispatch" | "initialize" | "isPaused" | "latestCheckpoint" | "localDomain" | "owner" | "pause" | "process" | "proof" | "recipientIsm" | "renounceOwnership" | "root" | "setDefaultIsm" | "testHandle" | "transferOwnership" | "tree" | "unpause"): FunctionFragment;
...
export interface TestMailbox extends BaseContract {
    ...
    functions: {
        ...
        delivered(arg0: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
        ...
        initialize(_owner: string, _defaultIsm: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        initialize(_owner: string, _defaultIsm: string, overrides?: CallOverrides): Promise<void>;
        isPaused(overrides?: CallOverrides): Promise<boolean>;
        latestCheckpoint(overrides?: CallOverrides): Promise<[string, number]>;
        localDomain(overrides?: CallOverrides): Promise<number>;
        owner(overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        delivered(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        dispatch(_destinationDomain: BigNumberish, _recipientAddress: BytesLike, _messageBody: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<BigNumber>;
        initialize(_owner: string, _defaultIsm: string, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        delivered(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        dispatch(_destinationDomain: BigNumberish, _recipientAddress: BytesLike, _messageBody: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
