...
export interface TestRouterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "dispatch" | "dispatchWithGas" | "domains" | "enrollRemoteRouter" | "enrollRemoteRouters" | "handle" | "initialize" | "interchainGasPaymaster" | "interchainSecurityModule" | "isRemoteRouter" | "mailbox" | "mustHaveRemoteRouter" | "owner" | "renounceOwnership" | "routers" | "setInterchainGasPaymaster" | "setInterchainSecurityModule" | "setMailbox" | "transferOwnership"): FunctionFragment;
    encodeFunctionData(functionFragment: "dispatch", values: [BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "dispatchWithGas", values: [BigNumberish, BytesLike, BigNumberish, BigNumberish, string]): string;
    ...
    decodeFunctionResult(functionFragment: "dispatchWithGas", data: BytesLike): Result;
...
export interface TestRouter extends BaseContract {
    ...
    functions: {
        ...
        dispatchWithGas(_destinationDomain: BigNumberish, _messageBody: BytesLike, _gasAmount: BigNumberish, _gasPayment: BigNumberish, _gasPaymentRefundAddress: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        dispatchWithGas(_destinationDomain: BigNumberish, _messageBody: BytesLike, _gasAmount: BigNumberish, _gasPayment: BigNumberish, _gasPaymentRefundAddress: string, overrides?: CallOverrides): Promise<void>;
        domains(overrides?: CallOverrides): Promise<number[]>;
