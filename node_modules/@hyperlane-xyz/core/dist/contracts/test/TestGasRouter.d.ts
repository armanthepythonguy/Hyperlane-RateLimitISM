...
export interface TestGasRouterInterface extends utils.Interface {
    functions: {
        ...
        "dispatchWithGas(uint32,bytes)": FunctionFragment;
        "dispatchWithGas(uint32,bytes,uint256,uint256,address)": FunctionFragment;
        "dispatchWithGas(uint32,bytes,uint256,address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "destinationGas" | "dispatch" | "dispatchWithGas(uint32,bytes)" | "dispatchWithGas(uint32,bytes,uint256,uint256,address)" | "dispatchWithGas(uint32,bytes,uint256,address)" | "domains" | "enrollRemoteRouter" | "enrollRemoteRouters" | "handle" | "initialize" | "interchainGasPaymaster" | "interchainSecurityModule" | "isRemoteRouter" | "mailbox" | "mustHaveRemoteRouter" | "owner" | "quoteGasPayment" | "renounceOwnership" | "routers" | "setDestinationGas" | "setInterchainGasPaymaster" | "setInterchainSecurityModule" | "setMailbox" | "transferOwnership"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "dispatchWithGas(uint32,bytes)", values: [BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "dispatchWithGas(uint32,bytes,uint256,uint256,address)", values: [BigNumberish, BytesLike, BigNumberish, BigNumberish, string]): string;
    encodeFunctionData(functionFragment: "dispatchWithGas(uint32,bytes,uint256,address)", values: [BigNumberish, BytesLike, BigNumberish, string]): string;
    ...
    decodeFunctionResult(functionFragment: "dispatchWithGas(uint32,bytes)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "dispatchWithGas(uint32,bytes,uint256,uint256,address)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "dispatchWithGas(uint32,bytes,uint256,address)", data: BytesLike): Result;
...
export interface TestGasRouter extends BaseContract {
    ...
    functions: {
        ...
        dispatch(_destination: BigNumberish, _msg: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "dispatchWithGas(uint32,bytes)"(_destinationDomain: BigNumberish, _messageBody: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "dispatchWithGas(uint32,bytes,uint256,uint256,address)"(_destinationDomain: BigNumberish, _messageBody: BytesLike, _gasAmount: BigNumberish, _gasPayment: BigNumberish, _gasPaymentRefundAddress: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        "dispatchWithGas(uint32,bytes,uint256,address)"(_destinationDomain: BigNumberish, _messageBody: BytesLike, _gasPayment: BigNumberish, _gasPaymentRefundAddress: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        initialize(_mailbox: string, _interchainGasPaymaster: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "dispatchWithGas(uint32,bytes)"(_destinationDomain: BigNumberish, _messageBody: BytesLike, overrides?: CallOverrides): Promise<void>;
        "dispatchWithGas(uint32,bytes,uint256,uint256,address)"(_destinationDomain: BigNumberish, _messageBody: BytesLike, _gasAmount: BigNumberish, _gasPayment: BigNumberish, _gasPaymentRefundAddress: string, overrides?: CallOverrides): Promise<void>;
        "dispatchWithGas(uint32,bytes,uint256,address)"(_destinationDomain: BigNumberish, _messageBody: BytesLike, _gasPayment: BigNumberish, _gasPaymentRefundAddress: string, overrides?: CallOverrides): Promise<void>;
        domains(overrides?: CallOverrides): Promise<number[]>;
        ...
        initialize(_mailbox: string, _interchainGasPaymaster: string, overrides?: CallOverrides): Promise<void>;
        interchainGasPaymaster(overrides?: CallOverrides): Promise<string>;
        interchainSecurityModule(overrides?: CallOverrides): Promise<string>;
        isRemoteRouter(_domain: BigNumberish, _potentialRemoteRouter: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        mailbox(overrides?: CallOverrides): Promise<string>;
