...
export interface TestHyperlaneConnectionClientInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "initialize" | "interchainGasPaymaster" | "interchainSecurityModule" | "localDomain" | "mailbox" | "owner" | "renounceOwnership" | "setInterchainGasPaymaster" | "setInterchainSecurityModule" | "setMailbox" | "transferOwnership"): FunctionFragment;
...
export interface TestHyperlaneConnectionClient extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestHyperlaneConnectionClientInterface;
    ...
    functions: {
        initialize(_mailbox: string, overrides?: Overrides & {
    ...
    callStatic: {
        initialize(_mailbox: string, overrides?: CallOverrides): Promise<void>;
        interchainGasPaymaster(overrides?: CallOverrides): Promise<string>;
        interchainSecurityModule(overrides?: CallOverrides): Promise<string>;
        localDomain(overrides?: CallOverrides): Promise<number>;
        mailbox(overrides?: CallOverrides): Promise<string>;
...
//# sourceMappingURL=TestHyperlaneConnectionClient.d.ts.map