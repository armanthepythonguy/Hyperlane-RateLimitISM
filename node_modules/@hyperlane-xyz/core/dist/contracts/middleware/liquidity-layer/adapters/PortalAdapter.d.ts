...
export interface PortalAdapterInterface extends utils.Interface {
    functions: {
        ...
        "initialize(uint32,address,address,address)": FunctionFragment;
...
export interface PortalAdapter extends BaseContract {
    ...
    functions: {
        ...
        initialize(_localDomain: BigNumberish, _owner: string, _portalTokenBridge: string, _liquidityLayerRouter: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        hyperlaneDomainToWormholeDomain(arg0: BigNumberish, overrides?: CallOverrides): Promise<number>;
        initialize(_localDomain: BigNumberish, _owner: string, _portalTokenBridge: string, _liquidityLayerRouter: string, overrides?: CallOverrides): Promise<void>;
        interchainGasPaymaster(overrides?: CallOverrides): Promise<string>;
        interchainSecurityModule(overrides?: CallOverrides): Promise<string>;
        liquidityLayerRouter(overrides?: CallOverrides): Promise<string>;
        localDomain(overrides?: CallOverrides): Promise<number>;
