...
export interface InterchainQueryRouterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "domains" | "enrollRemoteRouter" | "enrollRemoteRouters" | "handle" | "initialize" | "interchainGasPaymaster" | "interchainSecurityModule" | "mailbox" | "owner" | "query(uint32,address,bytes,bytes)" | "query(uint32,((bytes32,bytes),bytes)[])" | "renounceOwnership" | "routers" | "setInterchainGasPaymaster" | "setInterchainSecurityModule" | "setMailbox" | "transferOwnership"): FunctionFragment;
