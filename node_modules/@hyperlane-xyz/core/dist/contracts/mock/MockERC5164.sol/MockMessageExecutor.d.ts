...
export interface MockMessageExecutor extends BaseContract {
    ...
    callStatic: {};
    filters: {
        "MessageIdExecuted(uint256,bytes32)"(fromChainId?: BigNumberish | null, messageId?: BytesLike | null): MessageIdExecutedEventFilter;
        MessageIdExecuted(fromChainId?: BigNumberish | null, messageId?: BytesLike | null): MessageIdExecutedEventFilter;
    };
    estimateGas: {};
    populateTransaction: {};
}
//# sourceMappingURL=MockMessageExecutor.d.ts.map