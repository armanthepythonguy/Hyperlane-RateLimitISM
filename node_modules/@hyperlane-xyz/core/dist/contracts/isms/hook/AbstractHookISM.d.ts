...
export interface AbstractHookISMInterface extends utils.Interface {
    functions: {
        "moduleType()": FunctionFragment;
        "verifiedMessageIds(bytes32,bytes32)": FunctionFragment;
        "verify(bytes,bytes)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "moduleType" | "verifiedMessageIds" | "verify"): FunctionFragment;
...
export interface AbstractHookISM extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AbstractHookISMInterface;
...
//# sourceMappingURL=AbstractHookISM.d.ts.map