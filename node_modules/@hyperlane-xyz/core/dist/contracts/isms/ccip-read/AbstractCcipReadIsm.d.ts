...
export interface AbstractCcipReadIsmInterface extends utils.Interface {
    functions: {
        "getOffchainVerifyInfo(bytes)": FunctionFragment;
        "moduleType()": FunctionFragment;
        "verify(bytes,bytes)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "getOffchainVerifyInfo" | "moduleType" | "verify"): FunctionFragment;
...
export interface AbstractCcipReadIsm extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AbstractCcipReadIsmInterface;
...
//# sourceMappingURL=AbstractCcipReadIsm.d.ts.map