...
export interface DomainRoutingIsmInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "domains" | "initialize(address,uint32[],address[])" | "initialize(address)" | "moduleType" | "modules" | "owner" | "renounceOwnership" | "route" | "set" | "transferOwnership" | "verify"): FunctionFragment;
...
export type ModuleSetEvent = TypedEvent<[number, string], ModuleSetEventObject>;
export type ModuleSetEventFilter = TypedEventFilter<ModuleSetEvent>;
...
export interface DomainRoutingIsm extends BaseContract {
    ...
    functions: {
        ...
        modules(origin: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        ...
        modules(origin: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        modules(origin: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
