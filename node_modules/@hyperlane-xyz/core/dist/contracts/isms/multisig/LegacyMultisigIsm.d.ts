...
export interface LegacyMultisigIsmInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "commitment" | "enrollValidator" | "enrollValidators" | "isEnrolled" | "moduleType" | "owner" | "renounceOwnership" | "setThreshold" | "setThresholds" | "threshold" | "transferOwnership" | "unenrollValidator" | "validatorCount" | "validators" | "validatorsAndThreshold" | "verify"): FunctionFragment;
...
export type CommitmentUpdatedEventFilter = TypedEventFilter<CommitmentUpdatedEvent>;
...
export type ValidatorEnrolledEvent = TypedEvent<[
    number,
    string,
    BigNumber
], ValidatorEnrolledEventObject>;
export type ValidatorEnrolledEventFilter = TypedEventFilter<ValidatorEnrolledEvent>;
export interface ValidatorUnenrolledEventObject {
    domain: number;
    validator: string;
    validatorCount: BigNumber;
}
export type ValidatorUnenrolledEvent = TypedEvent<[
    number,
    string,
    BigNumber
], ValidatorUnenrolledEventObject>;
export type ValidatorUnenrolledEventFilter = TypedEventFilter<ValidatorUnenrolledEvent>;
export interface LegacyMultisigIsm extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: LegacyMultisigIsmInterface;
...
//# sourceMappingURL=LegacyMultisigIsm.d.ts.map