...
class HyperlaneAppChecker {
    ...
    async checkProxiedContracts(chain) {
        ...
        await (0, utils_2.promiseObjAll)((0, utils_2.objMap)(contracts, async (name, contract) => {
    ...
    async checkUpgrade(chain, upgradeConfig) {
        ...
        const accountHasRole = await (0, utils_2.promiseObjAll)((0, utils_2.objMap)(upgradeConfig.timelock.roles, async (role, account) => ({
