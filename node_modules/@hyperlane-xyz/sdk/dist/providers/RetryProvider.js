...
class RetryJsonRpcProvider extends ethers_1.ethers.providers
    ...
    constructor(retryOptions, url, network) {
        super(url, network);
        (0, utils_1.assert)(retryOptions.maxRequests >= 1, 'RetryOptions.maxRequests must be >= 1');
        (0, utils_1.assert)(retryOptions.baseRetryMs >= 1, 'RetryOptions.baseRetryMs must be >= 1');
        this.retryOptions = retryOptions;
    }
    async send(method, params) {
        return (0, utils_1.retryAsync)(() => super.send(method, params), this.retryOptions.maxRequests, this.retryOptions.baseRetryMs);
    }
}
