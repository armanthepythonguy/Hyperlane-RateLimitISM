...
describe('LiquidityLayerRouter', async () => {
    ...
    before(async () => {
        ...
        config = (0, utils_1.objMap)(routerConfig, (chain, config) => {
            return {
                ...config,
                circle: {
    ...
    it('can transfer tokens via Circle', async () => {
        ...
        await local.dispatchWithTokens(remoteDomain, (0, utils_1.addressToBytes32)(recipient.address), mockToken.address, amount, LiquidityLayerRouterDeployer_1.BridgeAdapterType.Circle, '0x01');
    ...
    it('can transfer tokens via Portal', async () => {
        ...
        await mockToken.mint(signer.address, amount);
        await mockToken.approve(local.address, amount);
        await local.dispatchWithTokens(remoteDomain, (0, utils_1.addressToBytes32)(recipient.address), mockToken.address, amount, LiquidityLayerRouterDeployer_1.BridgeAdapterType.Portal, '0x01');
