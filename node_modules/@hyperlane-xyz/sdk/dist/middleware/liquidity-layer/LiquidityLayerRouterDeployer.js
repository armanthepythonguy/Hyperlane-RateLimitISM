...
class LiquidityLayerDeployer extends ProxiedRouterDeployer_1.ProxiedRouterDeployer {
    ...
    async enrollRemoteRouters(contractsMap, configMap, foreignRouters) {
        ...
        await super.enrollRemoteRouters((0, utils_1.objMap)((0, utils_1.objFilter)(contractsMap, (_, c) => !!c.circleBridgeAdapter), (_, contracts) => ({
        ...
        // Hack to allow use of super.enrollRemoteRouters
        await super.enrollRemoteRouters((0, utils_1.objMap)((0, utils_1.objFilter)(contractsMap, (_, c) => !!c.portalAdapter), (_, contracts) => ({
    ...
    async deployPortalAdapter(chain, adapterConfig, owner, router) {
        ...
        if (!(0, utils_1.eqAddress)(await router.liquidityLayerAdapters('Portal'), portalAdapter.address)) {
    ...
    async deployCircleBridgeAdapter(chain, adapterConfig, owner, router) {
        ...
        if (!(0, utils_1.eqAddress)(await circleBridgeAdapter.tokenSymbolToAddress('USDC'), adapterConfig.usdcAddress)) {
        ...
        if (!(0, utils_1.eqAddress)(await router.liquidityLayerAdapters('Circle'), circleBridgeAdapter.address)) {
